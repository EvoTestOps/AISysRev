...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column(
        "user", sa.Column("terms_version_accepted", sa.String(length=64), nullable=True)
    )
    op.add_column(
        "user",
    ...
    op.add_column(
        "user",
        sa.Column(
            "privacy_policy_version_accepted", sa.String(length=64), nullable=True
        ),
    )
    op.add_column(
        "user",
    ...
    op.add_column(
        "user",
        sa.Column("consent_anonymized_research_usage", sa.Boolean(), nullable=True),
    )
    op.add_column(
        "user",
        sa.Column(
