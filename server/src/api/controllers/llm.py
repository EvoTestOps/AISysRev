from src.core.llm_providers import providers
...
#     ]
#     try:
#         models = llmservice.get_llm().get_available_models()
#         data = models["data"]
#         models["data"] = [
#             model
#             for model in data
#             if model["name"] in valid_model_names
#             and all(
#                 param in (model["supported_parameters"] or [])
#                 for param in required_parameters
#             )
#         ]
#         models["data"] = sorted(models["data"], key=lambda model: model["name"].lower())
#         return models
